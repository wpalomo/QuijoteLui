CREATE OR REPLACE FORCE VIEW "V_ELE_FACTURAS" ("ID", "ID_CONTRIBUYENTE", "CODIGO", "NUMERO", "CODIGO_DOCUMENTO", "ESTABLECIMIENTO", "PUNTO_EMISION", "SECUENCIAL", "FECHA", "TOTAL_SIN_IVA", "TOTAL_CON_IVA", "IVA", "DESCUENTOS", "TOTAL", "TIPO_DOCUMENTO", "DOCUMENTO", "RAZON_SOCIAL", "DIRECCION", "GUIA_REMISION", "DIRECCION_ESTABLECIMIENTO") AS 
  SELECT 
    f.NUM_FACTURA as id,
    ...
    round(f.TOTAL_SIN_IVA,2) - DISMEMAYOR.pkg_info_descuento.fun_descuento_sin_iva('FAC', f.NUM_FACTURA) as TOTAL_SIN_IVA,
    round(f.TOTAL_CON_IVA,2) - DISMEMAYOR.pkg_info_descuento.fun_descuento_iva('FAC', f.NUM_FACTURA) as TOTAL_CON_IVA,
